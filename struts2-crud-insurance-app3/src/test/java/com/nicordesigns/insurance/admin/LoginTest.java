...
import com.nicordesigns.insurance.admin.Login;
...
public class LoginTest extends ConfigTest {
    ...
    public void FIXME_testLoginConfig() throws Exception {
        ActionConfig config = assertClass("insurance", "Login_input", "insurance.Login");
        assertResult(config, ActionSupport.SUCCESS, "Menu");
        assertResult(config, ActionSupport.INPUT, "/insurance/Login.jsp");
    }
